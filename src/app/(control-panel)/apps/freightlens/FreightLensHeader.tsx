...
interface FreightLensHeaderProps {
	selectedFcs: FcId[];
...
/**
 * Header toolbar for FreightLens Rolling 21 Days view.
 * Includes FC type, zone, warehouse filters, FC multi-select, pagination, and CSV export.
 */
function FreightLensHeader({
	selectedFcs,
	onFcsChange,
	fcType,
	onFcTypeChange,
...
export default FreightLensHeader;
